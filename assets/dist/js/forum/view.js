...
function code (a) {
	...
	$a.children('code').each(function () {
		...
		$(this).text(text);
		if (text.search(/<br\s?\/?>/) !== -1 || text.length > 200) $(this).wrap('<dl class="codebox contcode hidecode"></dl>').before('<dt onclick="selectCode(this)" title="Select all" style="cursor:pointer" style="border: none;">Code:</dt>').wrap('<dd class="code_content"></dd>');
