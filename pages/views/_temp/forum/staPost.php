<div class="thead">
	...
	<div class="center col-lg-2 no-padding">
		Category
	</div>
	<div class="right col-lg-2 text-right no-padding-right">
		Last post by
	</div>
...
<li>
	<div class="lasttopic-title nowrap col-lg-6 no-padding-right">
	...
	<div class="center col-lg-2 no-padding nowrap">
		<a href="<? echo $tO['cat']['link'] ?>"><? echo $tO['cat']['title'] ?></a>
	</div>
	<div class="right col-lg-2 text-right nowrap no-padding-right">
