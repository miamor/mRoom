		...
		<div class="col-lg-8 no-padding-right">
			...
			<div class="form-group nav-tabs-custom">
				<ul class="nav nav_tabs">
					...
					<li><a href="#t2" data-toggle="tab">Generate output with standard code</a></li>
					<li><a href="#t3" data-toggle="tab">Generate testcases (input and output)</a></li>
				</ul>
				<div id="upload" class="tab-content" action="?do=upload&type=testcases">
					...
					<div id="t2" class="hide tab-pane">
						<div class="callout callout-info">To <b>generate output</b>, upload a <b>.zip</b>, <b>.tar</b>, <b>.gz</b> file:
							<ul>
					...
					<div id="t3" class="hide tab-pane">
						<div class="callout callout-info">To <b>generate testcases</b>:
							<ol>
								<li>Define number of input to generate and one standard input</li>
								<li>Upload <b>1</b> standard code file for generating output, named <b>standard.<i>[ext]</i></b> <i>(eg. standard.cpp)</i></li>
							</ol>
						</div>
						<h5 class="generate_input">Generate input </h5>
						<div class="form-group">
							<div class="col-lg-3 control-label no-padding">Number of input</div>
							<div class="col-lg-9 no-padding-right">
								<input type="text" name="in_num" class="form-control" placeholder="Input numbers"/>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="form-group">
							<div class="col-lg-3 control-label no-padding">Input fields</div>
							<div class="col-lg-9 no-padding-right">
								<input type="number" name="in_fields" class="form-control" placeholder="How many fields per input"/>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="form-group">
							<div class="col-lg-3 control-label no-padding">Field 1</div>
							<div class="col-lg-9 no-padding-right">
								<select type="number" name="in_type[]" class="form-control">
