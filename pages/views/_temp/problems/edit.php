...
<form action="?do=edit" class="bootstrap-validator-forms new-problem" method="POST" enctype="multipart/form-data">
	<div class="col-lg-8 p-info no-padding-left">
		...
		<div class="form-group">
			...
			<div class="col-lg-9 no-padding-right">
				<input type="text" name="title" class="form-control" placeholder="Problem title" value="<?php echo $problem->title ?>"/>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9 no-padding-right"><textarea name="content"><?php echo $problem->content ?></textarea></div>
			<div class="clearfix"></div>
		</div>
	</div>
	...
	<div class="col-lg-4 b-info no-padding-right">
		...
		<div class="form-group">
			...
			<div class="col-lg-9 no-padding-right">
				<select name="lang[]" multiple class="form-control chosen-select">
					<option value="cpp" <?php if (in_array('cpp', $problem->lang)) echo 'selected' ?>>C++</option>
					<option value="c" <?php if (in_array('c', $problem->lang)) echo 'selected' ?>>C</option>
					<option value="java" <?php if (in_array('java', $problem->lang)) echo 'selected' ?>>Java</option>
					<option disabled value="python" <?php if (in_array('python', $problem->lang)) echo 'selected' ?>>Python</option>
				</select>
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="form-group">
			...
			<div class="col-lg-9 no-padding-right">
				<label class="radio">
					<input type="radio" value="0" disabled <?php if ($problem->stt == 0) echo 'checked' ?> name="type"/> Normal
				</label>
				<label class="radio">
					<input type="radio" value="1" disabled <?php if ($problem->stt == 1) echo 'checked' ?>  name="type"/> For test
				</label>
				<label class="radio">
					<input type="radio" value="-1" disabled <?php if ($problem->stt == -1) echo 'checked' ?> name="type"/> Hidden
				</label>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
	...
	<div class="more" style="margin:20px 0">
		<div class="col-lg-5 no-padding-left">
			...
			<div class="form-group">
				...
				<div class="col-lg-8 no-padding-right">
					<select class="form-control" name="in_type">
						<option <?php if ($problem->inputType == 'standard') echo 'selected' ?> value="standard">Standard</option>
					</select>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-8 no-padding-right">
					<select class="form-control" name="out_type">
						<option <?php if ($problem->outputType == 'standard') echo 'selected' ?> value="standard">Standard</option>
					</select>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-8 no-padding-right">
					<select class="form-control" name="score_type">
						<option <?php if ($problem->score == 'ACM') echo 'selected' ?> value="ACM">ACM</option>
					</select>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-8 no-padding-right">
					<input type="number" min="0" max="100" value="1" name="time_limit" class="form-control left" value="<?php echo $problem->time_limit ?>" style="width:80%!important"/> 
			...
			<div class="form-group">
				...
				<div class="col-lg-8 no-padding-right">
					<input type="number" min="10" max="10000" value="256" name="memory_limit" class="form-control left" value="<?php echo $problem->memory_limit ?>" style="width:80%!important"/> 
